...
const Signup = () => {
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-secondary-50 to-white">
      <div className="max-w-md w-full space-y-8 animate-fade-in">
        {/* Header */}
        <div className="text-center">
          <h1 className="font-serif text-4xl font-bold text-gray-900 mb-2">
            Join Where's Maldives
          </h1>
          <p className="text-gray-600">
            Create your account and start exploring paradise
          </p>
        </div>
